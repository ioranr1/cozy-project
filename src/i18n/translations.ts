...
export const translations = {
  he: {
    ...
    howItWorks: {
      ...
      step2: {
        title: 'צימוד מצלמה ',
        description: 'בצעו את ההוראות הפשוטות לאחר ההתקנה (פעם אחת) בכדי לצמד את    המצלמה של הלפטופ  לאפליקאציה',
      },
      step3: {
        title: 'צפה מכל מקום',
        description: 'כנס מטלפון הנייד ל https://aiguard24.com ולאחר רישום ואימות אתה מחובר.\nכדי שהאיקון של האפליקאציה  יופיע באופן קבוע בצע "הוסף לדף הבית"',
      },
    },
    // Auth
    auth: {
