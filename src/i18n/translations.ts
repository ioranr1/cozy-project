      ...
      steps: {
        ...
        connect: {
          ...
          details: [
            ...
            'התחבר עם אותו חשבון שהתחברת בלאפטופ , קבל קוד אימות בוואטסאפ ואתה יכול להתחיל לצפות ולהפעיל ניטור ',
            'כדי שהאיקון של האפליקאציה יופיע באופן קבוע על מסך הבית בנייד שלך  בצעה "הוסף לדף הבית" ( אין צורך להורדה מחנות האפליקאציות ) ',
          ],
        },
        update: {
          title: 'עדכון גרסה',
