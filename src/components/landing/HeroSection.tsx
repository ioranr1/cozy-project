            ...
            <div className="text-center mb-6">
              <div className="relative inline-block">
                ...
                <div className="relative flex flex-col items-center gap-1 px-6 py-3 rounded-lg bg-[#0a0f1e]/40 backdrop-blur-md border border-white/10">
                  <span className="text-lg md:text-xl font-semibold tracking-wider bg-gradient-to-r from-cyan-200 via-white to-blue-200 bg-clip-text drop-shadow-[0_0_8px_rgba(34,211,238,0.4)] text-amber-300">
                    Portable Private Travel Security
                  </span>
                  <span className="text-sm md:text-base font-medium tracking-wide text-amber-300">
