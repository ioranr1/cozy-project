...
```
┌──────────────────────────────────────────────────────────────────────────┐
│  Mode        │  Away Active  │  Display Off  │  30s Loop   │  Prevents  │
│              │               │               │             │  Sleep     │
├──────────────────────────────────────────────────────────────────────────┤
│  Manual      │      ✅       │      ✅       │     ✅      │     ✅     │
│  Auto-Away   │      ✅       │      ❌       │     ❌      │     ❌     │
...
### v1.2.0 (2026-01-28)
- **CRITICAL FIX**: Auto-Away no longer starts `powerSaveBlocker`
- This allows the computer to sleep normally when Auto-Away is active
- Manual Away Mode still prevents sleep (intended behavior)
- Fixes issue where computer stayed awake indefinitely after closing Away Mode
